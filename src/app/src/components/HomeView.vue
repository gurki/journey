...
function generateModel() {
  ...
  // Store the configuration in localStorage for the generation page
  localStorage.setItem('journeyConfig', JSON.stringify(generationConfig.value));
      ...
      <div class="footer-content">
        <div class="selection-info">
          <div v-if="mapSelection && mapSelection.bounds">
            <button @click="generateModel" class="generate-button">Generate</button>
          </div>
        </div>
      </div>
    </footer>
